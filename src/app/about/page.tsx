            ...
            {[
              {
                ...
                description:
                  "Deep knowledge across tech, finance, healthcare, and other key industries.",
                points: [
              ...
              },
              {
                ...
                description:
                  "Over 15,000 successful placements with a 98% client satisfaction rate.",
                points: [
                  "High success rate",
                  "Quality matches",
              ...
              },
              {
                ...
                description:
                  "Tailored approach for both candidates and employers with dedicated support.",
                points: [
              ...
              },
              {
                ...
                description:
                  "Advanced matching algorithms and modern tools for efficient recruitment.",
                points: [
                  "AI-powered matching",
                  "Modern platform",
                  "Efficient processes",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-teal-100 mb-8">
              ...
              success through TalentConnect.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-teal-600 hover:bg-slate-50 px-8 py-3 text-lg"
              >
                Get Started Today
